...
function SearchOverlay() {
  ...
  return (
    <div 
      ...
      // className='absolute bg-green-200 inset-0 z-50 flex justify-center '
      // className='relative bg-green-200 inset-0 z-50 flex justify-center w-full'
      // className='relative bg-green-200  w-full'
      // className='relative bg-green-200  w-full'
      className='relative bg-green-200 z-1000 mx-3 w-full'
      onClick={handleOverlayClick}
    > 
        {/* <div className='bg-red-400 h-full absolute top-20 w-full py-8'> */}
        {/* <div className='bg-red-400 h-full absolute top-20   py-8'> */}
        {/* <div className='bg-white rounded-lg shadow-2xl w-full max-w-4xl mx-4 h-fit max-h-[80vh] overflow-hidden'> */}
        {/* <div className='absolute bg-red-100 rounded-lg shadow-2xl w-full max-w-4xl mx-4 h-fit max-h-[80vh] overflow-hidden right-0'> */}
      <div className='absolute bg-gray-200 rounded-lg w-fit'>
          {/* <div className=''> */}

          {/* search query display */}
          {/* sibling to PARENT of LEFT & RIGHT SIDE */}
          {/* <div className='p-4 border-Jb bg-gray-50'> */}
          <div className='p-4 border-Jb bg-gray-300'>
          ...
          {/* parent to LEFT SIDE and RIGHT SIDE */}
          <div className='flex  overflow-y-auto max-h-[70vh]'>
